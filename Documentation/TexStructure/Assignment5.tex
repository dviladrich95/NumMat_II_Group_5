...
\begin{figure}[H]
	...
	\caption{Plot of the BVP. Notice the upwards curve that indictes that a positive second order derivative is needed }
	\label{fig:a05ex01domain2}
\end{figure}
...
The log-log plot of the error with respect to a fine meshsize of $N=2^10$ for a given mesh size up to $2^9=512 \approx 500$ gives us a regression coefficient of $r^2=-0.99$ leading to an order of convergence of $p \approx 1$

\begin{figure}[H]
	\centering
	\includegraphics[width=0.68\textwidth]{Documentation/Figures/a05ex02d_error.png} 
	\caption{log-log plot of the error versus the solution with very fine mesh $N=2^10$ versus the stepsize $h_i$ }
	\label{fig:a05ex01domain2}
\end{figure}
