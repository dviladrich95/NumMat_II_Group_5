...
%
% ----------------
\addSubExercise{c \& d}The solution and plot codes can be found in \texttt{NumMatEx2\_Program.py}.
...
\def\MeshFigWidth{220pt}
	\begin{subfigure}{0.5\hsize}
		\centering
		\includegraphics[width=\MeshFigWidth]{a02e02plot_1.png} 
	\end{subfigure}
	\begin{subfigure}{0.5\hsize}
		\centering
		\includegraphics[width=\MeshFigWidth]{a02e02plot_2.png} 
	\end{subfigure}
	\vfill
	\begin{subfigure}{0.5\hsize}
		\centering
		\includegraphics[width=\MeshFigWidth]{a02e02plot_3.png} 
	\end{subfigure}
	\begin{subfigure}{0.5\hsize}
		\centering
		\includegraphics[width=\MeshFigWidth]{a02e02plot_4.png} 
	\end{subfigure}
